                    ...
                    <Accordion.Body>
                        <Form >
                            <Row>
                                ...
                                <Col lg={4} className='d-flex justify-content-center pt-3'>
                                ...
                                <Col xs={{ span: 6, offset: 1 }} lg={{ span: 9, offset: 1 }} className='d-flex align-items-center'>
                                    <Button variant="primary" onClick={() => handleResetBtn()}>Reset</Button>
                                </Col>
                            </Row>
                        </Form>
                    </Accordion.Body>
