    ...
    return (
        <div style={{ backgroundColor: 'black' }}>
            ...
            <NavLink className='nav-bar-link text' to='/playerregister'><ListGroup.Item action variant="secondary" className='py-3 a' ><i className="bi bi-journal-text"></i> REGISTRATION
                ...
                <NavLink to='/'><ListGroup.Item action variant="secondary" className='py-3 a' style={{ position: 'absolute', bottom: 0 }}><i className="bi bi-box-arrow-left"></i> LOG OUT</ListGroup.Item></NavLink>
            </ListGroup>
        </div>
    )
}
